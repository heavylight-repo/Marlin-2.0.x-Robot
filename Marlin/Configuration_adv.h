...
#define HOMING_BUMP_MM      { 5, 5, 5, 5, 2, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 6, 6, 6, 6, 6, 6 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 5, 5, 5, 5, 5, 5 }  // (mm) Backoff from endstops after homing

#define QUICK_HOME                          // If G28 contains XY do a diagonal move first //Tobbe
...
#define AXIS_RELATIVE_MODES { false, false, false, false, false, false } //Tobbe
...
// LCD Print Progress options
  ...
  #define SD_FINISHED_STEPPERRELEASE true   // Disable steppers when SD Print is finished //Tobbe
  ...
  //#define LONG_FILENAME_HOST_SUPPORT //Tobbe Detta funkar ej med gamla TFT35 firmware. Ger "Loading...""
 ...
 */
#define REALTIME_REPORTING_COMMANDS  //Tobbe
 ...
 */
  ...
  //#define STEALTHCHOP_I //Tobbe
  //#define STEALTHCHOP_J //Tobbe
  //#define STEALTHCHOP_K //Tobbe
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //Tobbe
